...
if (process.argv.length < 5) {
    console.error("Usage: node update-metadata <project-name> <project-description> <output-filename> [github-project-url] [git-ssh-url]");
    return -1;
}
...
var sshUrl = process.argv.length > 6 ? process.argv[6] : null;
